...
python3 extract_stats/convert_to_csv.py ${OP_DIR}/train_loss_scores.txt ${OP_DIR}/train_loss_scores_${ID}.csv 
python3 extract_stats/convert_to_csv.py ${OP_DIR}/eval_loss_scores.txt ${OP_DIR}/eval_loss_scores_${ID}.csv 

#python3 extract_stats/plot_train_loss.py ${OP_DIR}/train_loss_scores.csv ${OP_DIR}/train_loss_scores_${ID}.svg || { echo "Error: exited"; return 0; }
#python3 extract_stats/plot_eval_loss.py ${OP_DIR}/eval_loss_scores.csv ${OP_DIR}/eval_loss_scores_${ID}.svg || { echo "Error: exited"; return 0; }
python3 extract_stats/plot_train_loss.py ${OP_DIR}/train_loss_scores_${ID}.csv ${OP_DIR}/train_loss_scores_${ID}.svg 
python3 extract_stats/plot_eval_loss.py ${OP_DIR}/eval_loss_scores_${ID}.csv ${OP_DIR}/eval_loss_scores_${ID}.svg 
